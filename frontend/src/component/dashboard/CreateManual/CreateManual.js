    ...
    <>
      <div className="Listings">
        ...
        <form>
          ...
          <div class="mb-3">
            <label for="InputMagic" class="form-label">Magic Link</label>
            <div className="Magic_Linkinput">
              <input type="text" class="form-control" id="InputMagic" placeholder="Paste your Magic Link" />
              <img src={copy_icon} />
            </div>
            <div class="form-text">This can be added from any Real Estate website</div>
          </div>
          <div className='or'>
            <p>OR</p>
          </div>
          <Button variant="outlined" className="btn2" component={RouterLink} to="/add_address">
            Create manually
          </Button>
